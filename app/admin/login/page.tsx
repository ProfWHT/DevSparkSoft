...
export default function AdminLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : 'লগইন ত্রুটি হয়েছে')
    } finally {
      setIsLoading(false)
    }
  }
          ...
          <div className="text-center mb-4">
            <Link href="/" className="inline-flex items-center gap-2">
              <div className="bg-primary text-primary-foreground px-3 py-2 rounded">
                <span className="text-xl font-bold">প্রফুক</span>
              </div>
            </Link>
          </div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                আপনার অ্যাকাউন্টে লগইন করতে ইমেইল ও পাসওয়ার্ড দিন
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="flex flex-col gap-6">
                  <div className="grid gap-2">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="admin@profuktv.site"
                      required
                      value={email}
