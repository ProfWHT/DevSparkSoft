...
export const COMPANY_INFO = {
  ...
  email: "taksidwalid150@gmail.com",
...
export const SERVICES: Service[] = [
  { 
    ...
    description: "Crafting responsive, high-performance websites and web apps with modern technologies.",
  ...
  { 
    icon: RocketIcon, 
    title: "Market & Escrow Services", 
    description: "Secure escrow and marketplace services for Google Play, AdMob, AdSense, and Applovin accounts.",
    longDescription: "We provide specialized escrow services for buying and selling premium developer accounts. Whether it's Google Play Console, AdMob, AdSense, or Applovin, we ensure secure transactions and professional account handovers.",
    features: [
      "Secure Escrow for Account Trading",
      "Google Play Console Market",
      "AdMob & AdSense Account Brokerage",
      "Applovin & Affiliate Account Services"
    ],
    image: "https://i.ibb.co/3y9kx5Z4/IMG-7272.jpg"
  },
  { 
    icon: MobileAppIcon, 
    title: "App Publishing & ASO", 
    description: "Expert App Store Optimization (ASO) and publishing services for global markets including Russia, Ukraine, and China.",
    longDescription: "From ideation to launch, we specialized in high-performance mobile apps and Web-View solutions. We handle the entire publishing process and provide expert App Store Optimization (ASO) to target specific regions like Russia, Ukraine, and China with localized SEO strategies.",
    features: [
      "App Publishing & Store Management",
      "Native & Web-View App Development",
      "Expert ASO & Global SEO Targeting",
      "Russia, Ukraine & China Market Entry"
    ],
  ...
  { 
    ...
    description: "Driving growth with data-driven marketing strategies including SEO, SMM, and affiliate marketing.",
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    id: '6',
    author: BLOG_AUTHOR,
    titleBn: "গ্লোবাল অ্যাপ পাবলিশিং এবং এএসও (ASO) এর মাধ্যমে আন্তর্জাতিক বাজারে গ্রাহক বাড়ান",
    titleEn: "Grow Globally with Expert App Publishing and ASO in Russia, China, and Ukraine",
    slug: "global-app-publishing-aso-targeting-russia-china-ukraine",
    excerptBn: "আন্তর্জাতিক বাজারে আপনার অ্যাপের সফলতা নিশ্চিত করতে সঠিক এএসও (ASO) এবং পাবলিশিং কৌশল অপরিহার্য। জানুন কিভাবে আমরা রাশিয়া, চীন এবং ইউক্রেনের মতো বাজারে আপনার অ্যাপকে পৌঁছে দিতে পারি।",
    excerptEn: "To ensure your app's success in international markets, the right ASO and publishing strategy are essential. Learn how we can help your app reach markets like Russia, China, and Ukraine.",
    contentBn: "আজকের প্রতিযোগিতামূলক বিশ্বে শুধুমাত্র একটি অ্যাপ তৈরি করাই যথেষ্ট নয়, সেটিকে সঠিক গ্রাহকের কাছে পৌঁছে দেওয়া এবং সেখানে শীর্ষস্থানে ধরে রাখা একটি বড় চ্যালেঞ্জ। বিশেষ করে রাশিয়া (Russia), চীন (China), এবং ইউক্রেন (Ukraine) এর মতো বড় বাজারগুলোতে অ্যাপ পাবলিশিং এর জন্য প্রয়োজন বিশেষ কৌশল।\n\n## এএসও (ASO) কি এবং এটি কেন জরুরি?\nএএসও বা App Store Optimization হলো আপনার অ্যাপকে প্লে-স্টোর বা অ্যাপ-স্টোর এ র‍্যাঙ্ক করানোর পদ্ধতি। আমরা প্রতিটি দেশের ভাষা এবং সংস্কৃতি অনুযায়ী কাস্টমাইজড কি-ওয়ার্ড রিসার্চ করি।\n\n## কেন রাশিয়া, চীন এবং ইউক্রেন টার্গেট করবেন?\nএই দেশগুলোতে অ্যাপ ব্যবহারকারীর সংখ্যা বিশাল এবং প্রতিযোগিতাও অনেক। আমাদের টিম জানে কিভাবে স্থানীয় নিয়ম মেনে অ্যাপ পাবলিশ করতে হয় এবং গ্লোবাল এসইও (SEO) এর মাধ্যমে অর্গানিক ট্রাফিক বাড়াতে হয়।\n\nআমাদের **অ্যাপ পাবলিশিং এবং এএসও সার্ভিস** আপনার ব্যবসার সীমানা ছাড়িয়ে বৈশ্বিক পরিচয় দেবে। আজই আমাদের সাথে **যোগাযোগ করুন** ([/contact](/contact)) আরও বিস্তারিত জানতে।",
    contentEn: "In today's competitive world, simply creating an app isn't enough. Reaching the right audience and staying on top is the real challenge, especially in massive markets like Russia, China, and Ukraine, which require specialized publishing strategies.\n\n### What is ASO and Why is it Crucial?\nASO (App Store Optimization) is the process of ranking your app higher in app stores. We perform customized keyword research based on local languages and cultures to ensure maximum visibility.\n\n### Why Target Russia, China, and Ukraine?\nThese regions have a massive user base and unique app ecosystems. Our team understands how to navigate local regulations and use global SEO techniques to drive organic growth in these specific territories.\n\nOur **App Publishing & ASO services** are designed to take your app beyond borders. **Contact us today** ([/contact](/contact)) for a consultation.",
    seo: {
      "metaTitleBn":"বাংলাদেশে গ্লোবাল অ্যাপ পাবলিশিং ও এএসও সার্ভিস | DevSpark Soft IT",
      "metaTitleEn":"Global App Publishing & ASO Specialist in Bangladesh | DevSpark Soft IT",
      "metaDescBn":"রাশিয়া, চীন এবং ইউক্রেনের মতো আন্তর্জাতিক বাজারে অ্যাপ পাবলিশিং এবং এএসও (ASO) এর মাধ্যমে আপনার ব্যবসার বৈশ্বিক প্রসার নিশ্চিত করুন।",
      "metaDescEn":"Expand your business globally with professional app publishing and ASO services targeting Russia, China, and Ukraine. Expert localized SEO strategy."
    },
    imageKeywords: ["global app market", "ASO strategy", "Russia China Ukraine tech"],
    coverAltBn:"একটি বিশ্ব মানচিত্র যেখানে প্রযুক্তিগত সংযোগ এবং অ্যাপ পাবলিশিং এর চিত্র ফুটিয়ে তোলা হয়েছে।",
    coverAltEn:"A global map showing technological connections and app publishing integration.",
    publishedDate: "2024-08-15",
    category: "Mobile Development",
    tags: ["ASO", "App Publishing", "Global SEO"],
    coverImage: "https://images.unsplash.com/photo-1526628953301-3e589a6a8b74?q=80&w=2000&auto=format&fit=crop"
  },
  {
    ...MOCK_CONTENT,
    id: '1',
